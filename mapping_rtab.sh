...
"gnome-terminal -- bash -c ' ros2 launch rtab_mapping rtab_mapping_launch.py   ; exec bash;'"
...
"gnome-terminal -- bash -c ' ros2 launch rtab_mapping display_rtabmap_map_launch.py   ; exec bash;'"
)
