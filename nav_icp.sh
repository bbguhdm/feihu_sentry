...
"gnome-terminal -- bash -c ' ros2 launch icp_localization_ros2 bringup.launch.py ; exec bash;'"
"gnome-terminal -- bash -c ' ros2 launch robot_navigation2 bring_launch.py  ; exec bash;'"
)
